...
- example of local storage class and pv/pvc as in [local_storage.md](/docs/local_storage.md)
...
more help commands of local-ai can be found at [local_ai_test.md](docs/local_ai_test.md)
